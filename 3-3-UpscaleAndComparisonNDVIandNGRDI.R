...
Endalen_2019_05_28 <- list('D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Endalen_2019_05_28/Sentinel2/20190528T121659_20190528T121658_T33XWG.tif',
                           ...
                           'Endalen',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Endalen_2019_05_28/eBeeX/2019_05_28_endalen_4band_47_mosaic_green.tif',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Endalen_2019_05_28/eBeeX/2019_05_28_endalen_4band_47_mosaic_red.tif')
...
Endalen_2019_07_30 <- list('D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Endalen_2019_07_30/Sentinel2/20190728T123701_20190728T123756_T33XWG.tif',
                           ...
                           'Endalen',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Endalen_2019_07_30/eBeeX/2019-07-30_endalen_4band_mosaic_green.tif',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Endalen_2019_07_30/eBeeX/2019-07-30_endalen_4band_mosaic_red.tif')
...
Janssonhaugen_2019_07_20 <- list('D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Janssonhaugen_2019_07_20/Sentinel2/20190728T123701_20190728T123756_T33XWG.tif',
                           ...
                           'Janssonhaugen',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Janssonhaugen_2019_07_20/eBeeX/2019_07_20_jan_4band_64_mosaic_green.tif',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Janssonhaugen_2019_07_20/eBeeX/2019_07_20_jan_4band_64_mosaic_red.tif')
...
Sassendalen_2019_07_23 <- list('D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Sassendalen_2019_07_23/Sentinel2/20190727T130721_20190727T130715_T33XWG.tif',
                           ...
                           'Sassendalen',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Sassendalen_2019_07_23/eBeeX/sassen_4band_67_mosaic_green.tif',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Sassendalen_2019_07_23/eBeeX/sassen_4band_67_mosaic_red.tif')
...
Todalen_2019_05_10 <- list('D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Todalen_2019_05_10/Sentinel2/20190510T120651_20190510T120649_T33XWG.tif',
                         ...
                         'Todalen small',
                         'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Todalen_2019_05_10/eBeeX/2019_05_10_todalen_4band_24_mosaic_green.tif',
                         'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Todalen_2019_05_10/eBeeX/2019_05_10_todalen_4band_24_mosaic_red.tif')
...
Todalen_2019_07_28 <- list('D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Todalen_2019_07_28/Sentinel2/20190728T123701_20190728T123756_T33XWG.tif',
                           ...
                           'Todalen small',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Todalen_2019_07_28/eBeeX/todalen_merged_last_try_mosaic_green.tif',
                           'D:/1-Sentinel2Project/3-Sentinel2eBeeX/1-Data/Todalen_2019_07_28/eBeeX/todalen_merged_last_try_mosaic_red.tif')
...
for (i in data_list) {
  ...
  if(mode == 'NDVI'){
    ...
    proj_name <- i[3]
    title <- ggdraw() + draw_label(paste('NDVI Pixel-by-pixel correlation between\nDrone and Sentinel 2 in', proj_name, sep = ' '),
    ...
    s2_data <- stack(i[1])
    # Import Drone Raster
    ebee_green <- stack(i[4])
    names(ebee_green) <- c('green')
    ebee_red <- stack(i[5])
    names(ebee_red) <- c('red')
    ...
    # Calculate NGRDI Values for eBeeX
    ebee_ndvi <- (ebee_green - ebee_red) / (ebee_green + ebee_red)
    names(ebee_ndvi) <- c('NDVI')
    
    # Calculate NGRDI for Sentinel 2
    s2_ndvi <- (s2_data[[3]] - s2_data[[4]]) / (s2_data[[3]] + s2_data[[4]])
    ...
    p_ebee_ndvi <- ggplot() +
      geom_raster(data = df_ebee_ndvi, aes(x = x, y = y, fill = name_eBee_ndvi)) +
      scale_fill_distiller(name = 'NGRDI', direction = 1,
                           limits = c(-1, 1), palette = 'BrBG') +
      labs(x = 'East', y = 'North') +
      theme_cowplot() +
      theme(
    ...
    p_s2_ndvi <- ggplot() +
      geom_raster(data = df_s2_ndvi, aes(x = x, y = y, fill = name_s2_ndvi)) +
      scale_fill_distiller(name = 'NGRDI', direction = 1,  # scale_fill_viridis_C  option = 'viridis'
                           limits = c(-1, 1), palette = 'BrBG') +
      labs(x = 'East', y = 'North') +
      theme_cowplot() +
      theme(
    ...
    p_graph <- ggplot(data = df_ndvi, aes(x = name_eBee_ndvi, y = name_s2_ndvi)) +
      ...
      xlim(-0.5, 1) +
      ylim(-0.5, 1) +
      labs(x = 'Drone - NGRDI', y = 'Sentinel 2 - NGRDI') +
      theme_ipsum() +
      theme(
        axis.title.x = element_text(size = 12, face = 'bold', hjust = 0.5),
        axis.title.y = element_text(size = 12, face = 'bold', hjust = 0.5),
    ...
    title <- ggdraw() + draw_label(paste('NGRDI Pixel-by-pixel correlation between\nDrone and Sentinel 2 in', proj_name, sep = ' '),
                                   fontface='bold', hjust = 0, vjust = 1) +
      theme(plot.margin = margin(0.0, 10.0, 0.0, 0.0, 'cm'))
