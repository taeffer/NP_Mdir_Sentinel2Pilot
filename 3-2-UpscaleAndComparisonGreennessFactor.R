...
spring_list_ndvi <- list('1-Data/Todalen_Spring/Sentinel2/20190510T120651_20190510T120649_T33XWG.tif',
                         '1-Data/Todalen_Spring/eBeeX/2019_05_10_todalen_4band/2019_05_10_todalen_4band_24_mosaic_green.tif',
                         '1-Data/Todalen_Spring/eBeeX/2019_05_10_todalen_4band/2019_05_10_todalen_4band_24_mosaic_red.tif')

spring_list_ndvi_landsat <- list('1-Data/Todalen_Spring/20190510_Landsat.tif',
                                 '1-Data/Todalen_Spring/eBeeX/2019_05_10_todalen_4band/2019_05_10_todalen_4band_24_mosaic_green.tif',
                                 '1-Data/Todalen_Spring/eBeeX/2019_05_10_todalen_4band/2019_05_10_todalen_4band_24_mosaic_red.tif')

summer_list_ndvi <- list('1-Data/Todalen_Summer/Sentinel2/20190728T123701_20190728T123756_T33XWG.tif',
                         '1-Data/Todalen_Summer/eBeeX/2019_07_27_todalen_4band/todalen_merged_last_try_mosaic_green.tif',
                         '1-Data/Todalen_Summer/eBeeX/2019_07_27_todalen_4band/todalen_merged_last_try_mosaic_red.tif')

summer_list_ndvi_landsat <- list('1-Data/Todalen_Summer/20190727_Landsat.tif',
                                 '1-Data/Todalen_Summer/eBeeX/2019_07_27_todalen_4band/todalen_merged_last_try_mosaic_green.tif',
                                 '1-Data/Todalen_Summer/eBeeX/2019_07_27_todalen_4band/todalen_merged_last_try_mosaic_red.tif')


data_list <- list(spring_list_ndvi, spring_list_ndvi_landsat, summer_list_ndvi, summer_list_ndvi_landsat)
...
for (i in data_list) {
  ...
  if(str_sub(unlist(i[1]), -11) == 'Landsat.tif'){
    ...
    p_graph <- ggplot(data = df_ndvi, aes(x = name_eBee_ndvi, y = name_s2_ndvi)) +
      ...
      xlim(-0.5, 1) +
      ylim(-0.5, 1) +
      labs(x = 'Drone - NGRDI', y = 'Landsat - NGRDI') +
      theme_ipsum() +
      theme(
